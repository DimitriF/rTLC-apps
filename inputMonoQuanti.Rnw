...
<<echo = FALSE, results = 'asis',fig.height=4,fig.width=8>>=
if(input$mono.knitr.file.name == T){
  ...
  print(xtable(data),include.rownames=F,include.colnames=F)
}
...
<<echo = FALSE,fig.height=2.5,fig.width=8>>=
...
<<echo = FALSE, results = 'asis',fig.height=2.5,fig.width=8>>=
  ...
  if(input$mono.knitr.preprocess == T){  
    ...
    print(xtable(truc, caption = 'Preprocessing Options'),include.rownames=F,colnames=F)
  }
@
...
<<echo = FALSE, results = 'asis',fig.height=8,fig.width=8,error=FALSE,message=FALSE>>=
...
<<echo = FALSE, results = 'asis',fig.height=12,fig.width=10>>=
...
<<echo = FALSE, results = 'asis',fig.height=8,fig.width=8>>=
...
if(input$mono.knitr.prediction.summary.model == T | input$mono.knitr.var.select ==T){
  print(xtable(selection.table()[selection.table()$use==T,], caption = 'Variables Selection'),include.rownames=F,colnames=T)
}
@
